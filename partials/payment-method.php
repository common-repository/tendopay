...
?>
<li class="wc_payment_method payment_method_<?php echo esc_attr($gateway->id); ?> payment_method_<?php echo esc_attr($gateway->id); ?>_customized">
    ...
    <label for="payment_method_<?php echo esc_attr($gateway->id); ?>">
        <div class="tp-logo-cnt">
            <?php echo $gateway->get_icon(); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
        </div>
        <span class="tp-gtwy-name-cnt"><?php _e('Buy now, pay later<br/>on installments', 'tendopay'); ?></span>
    </label>
